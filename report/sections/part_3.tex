...
Looking at the learning curves, it progressively falls when the fit size increases, which indicates that more training samples may improve performance.
...
\bottomrule
\end{tabular}
\caption{Pearson $r$ correlation between each model's absolute log residual and the actual price.}
...
\begin{figure}[H]
\centering
\begin{subfigure}{\textwidth}\includegraphics[width=\linewidth]{figures/p4_resid_ridge.png}\end{subfigure}
\begin{subfigure}{\textwidth}\includegraphics[width=\linewidth]{figures/p4_resid_rf.png}\end{subfigure}
\begin{subfigure}{\textwidth}\includegraphics[width=\linewidth]{figures/p4_resid_ada.png}\end{subfigure}
